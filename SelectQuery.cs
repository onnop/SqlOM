...
namespace Reeb.SqlOM;
    ...
    public enum CompareOperator
    {
        ...
        Like,
        /// <summary>Substring. Use '%' sign trailing the value to match anything starting with the value</summary>
        StartsWith,
        /// <summary>Substring. Use '%' sign preceding the value to match anything ending with the value</summary>
        EndsWith,
        /// <summary>Substring. Use '%' signs in the value to match anything that does not contain the value</summary>
        NotLike,
        /// <summary>Substring. Use '%' sign trailing the value to match anything not starting with the value</summary>
        NotStartsWith,
        /// <summary>Substring. Use '%' sign preceding the value to match anything not ending with the value</summary>
        NotEndsWith,
    }
    ...
    public class SelectQuery : ICloneable
    {
        ...
        private string SQL
        {
            get
            {
                return new Render.SqlServerRenderer().RenderSelect(this);
            }
        }
        ...
        {
            if (columns.Count == 0)
                Columns.Add(new SelectColumn("*")); //throw new InvalidQueryException("A select query must have at least one column");

            if (fromClause.BaseTable is null)
        ...
        {
            SelectQuery newQuery = new()
            {
                top = top,
                groupByWithRollup = groupByWithRollup,
                groupByWithCube = groupByWithCube,
                distinct = distinct,
