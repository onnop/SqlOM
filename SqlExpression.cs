...
internal enum SqlExpressionType
    ...
    public class SqlExpression
    {
        ...
        SqlDatabaseFunction dataBaseFunction = SqlDatabaseFunction.None;

        CaseClause caseClause = new();
        ...
        /// <summary>
        /// Creates a SqlExpression which represents a nullable numeric value.
        /// </summary>
        /// <param name="val">Value of the expression</param>
        /// <returns>A SqlExpression which represents a numeric value</returns>
        public static SqlExpression Number(int? val)
        {
            if (val.HasValue)
            {
                return Constant(SqlConstant.Number(val.Value));
            }
            else
            {
        ...
        /// <param name="val">Value of the expression</param>
        /// <returns>A SqlExpression which represents a numeric value</returns>
        public static SqlExpression Number(long val)
        {
            return Constant(SqlConstant.Number(val));
        }
        ...
        /// <summary>
        /// Creates a SqlExpression which represents a boolean value.
        /// </summary>
        /// <param name="val">Value of the expression</param>
        /// <returns>A SqlExpression which represents a boolean value</returns>
        public static SqlExpression Boolean(bool val)
        {
            return Constant(SqlConstant.Boolean(val));
        }

        /// <summary>
        /// Creates a SqlExpression which represents a nullable boolean value.
        /// </summary>
        /// <param name="val">Value of the expression</param>
        /// <returns>A SqlExpression which represents a boolean value</returns>
        public static SqlExpression Boolean(bool? val)
        {
            if (val.HasValue)
            {
                return Constant(SqlConstant.Boolean(val.Value));
            }
        ...
        /// <summary>
        /// Creates a SqlExpression which represents a binary value.
        /// </summary>
        /// <param name="val">Value of the expression</param>
        /// <returns>A SqlExpression which represents a binary value</returns>
        public static SqlExpression Binary(byte[] val)
        {
            return Constant(SqlConstant.Binary(val));
        }

        public static SqlExpression Guid(Guid val)
        {
            return Constant(SqlConstant.Guid(val));
        }

        [Obsolete("Use a strongtyped SqlExpression")]
        public static SqlExpression Object(object val)
        {
            ...
            if (val == null || val is DBNull)
            {
                ...
                expr.type = SqlExpressionType.Null;
                return expr;
                //return Constant(SqlDataType.Number, "NULL");
            }
        ...
        /// <summary>
        /// Creates a SqlExpression which represents a nullable date value.
        /// </summary>
        /// <param name="val">Value of the expression</param>
        /// <returns>A SqlExpression which represents a nullable date value</returns>
        public static SqlExpression Date(DateTime? val)
        {
            if (val.HasValue)
            {
                return Constant(SqlConstant.Date(val.Value));
            }
            else
            {
                SqlExpression expr = new SqlExpression();
        ...
        public static SqlExpression DateDiff(DateDiff datePart, SqlExpression startDate, SqlExpression endDate)
        {
            SqlExpression expression = new SqlExpression();
            expression.type = SqlExpressionType.DateDiff;
            expression.val = datePart;
            expression.subExpr1 = startDate;
            expression.subExpr2 = endDate;
        ...
        /// <summary>
        /// Creates a SqlExpression with an Database function
        /// </summary>
        /// <param name="func">Aggregation function to be applied on the supplied expression</param>
        /// <param name="param">Parameter of the aggregation function</param>
        /// <returns></returns>
        public static SqlExpression Function(SqlDatabaseFunction func, SqlExpression param)
        {
            SqlExpression expr = new SqlExpression();
            expr.type = SqlExpressionType.Function;
            expr.subExpr1 = param;
            expr.dataBaseFunction = func;
            return expr;
        }
        ...
        internal SqlDatabaseFunction DatabaseFunction
        {
            get { return dataBaseFunction; }
        }
