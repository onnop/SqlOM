namespace Reeb.SqlOM;
    ...
    /// <summary>
    /// Specifies which function should be applied on a field
    /// </summary>
    public enum SqlDatabaseFunction
    {
        /// <summary>No function</summary>
        None,
        YYYYMMDD2DateTime,
    ...
    public class SelectColumn
    {
        ...
        /// <summary>
        /// Creates a SelectColumn with a column name, table, column alias and optional database function
        /// </summary>
        /// <param name="columnName">Name of a column</param>
        /// <param name="table">The table this field belongs to</param>
        /// <param name="columnAlias">Alias of the column</param>
