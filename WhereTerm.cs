...
{
    public enum WhereTermType { Compare, NotBetween, Between, In, NotIn, InSubQuery, InSubQueryObj, NotInSubQuery, NotInSubQueryObj, IsNull, IsNotNull, Exists, ExistsObj, NotExists, NotExistsObj, Raw, Execute }
    ...
    public class WhereTerm : ICloneable
    {
        ...
        public static WhereTerm CreateIn(SqlExpression expr, SelectQuery subquery)
        {
            WhereTerm term = new WhereTerm();
            term.expr1 = expr;
            term.subQuery = subquery;

            term.type = WhereTermType.InSubQueryObj;
        ...
        public static WhereTerm CreateIn(SqlExpression expr, SqlConstantCollection values)
        {
            ...
            //Fix for SQL  WHERE expr IN ()  with empty collection between () resulting in error Incorrect syntax near ')'.
            return CreateIn(expr, "SELECT NULL WHERE 1=2");
        }
        ...
        /// <returns></returns>
        public static WhereTerm CreateNotIn(SqlExpression expr, SelectQuery subQuery)
        {
            WhereTerm term = new WhereTerm();
            term.expr1 = expr;
            term.subQuery = subQuery;

            term.type = WhereTermType.NotInSubQueryObj;
        ...
        //[OP] toegevoegd op 29 okt 08
        public static WhereTerm Raw(string sql)
        {
            WhereTerm term = new WhereTerm();
            term.subQuery = sql;
            term.type = WhereTermType.Raw;
            return term;
        }
        ...
        /// <summary>
        /// Creates a WhereTerm which checks whether a value is not in a specifed range.
        /// </summary>
        /// <param name="expr">Expression which yeilds the value to be checked</param>
        /// <param name="lowBound">Expression which yeilds the low bound of the range</param>
        /// <param name="highBound">Expression which yeilds the high bound of the range</param>
        ...
        /// All expressions must be of compatible types.
        /// </remarks>
        public static WhereTerm CreateNotBetween(SqlExpression expr, SqlExpression lowBound, SqlExpression highBound)
        {
            WhereTerm term = new WhereTerm();
            term.expr1 = expr;
            term.expr2 = lowBound;
            ...
            term.type = WhereTermType.NotBetween;
